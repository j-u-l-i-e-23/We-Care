<%-- 
    Document   : RejectedFamily.jsp
    Created on : Oct 9, 2021, 11:41:56 AM
    Author     : User
--%>
...
<html>
    ...
    <body>
        ...
        <table border="1" align='center'>
            ...
            <%
                int i = 0;
                String sel = "select * from tbl_family f inner join tbl_wardplaces p on p.wp_id=f.wp_id inner join tbl_ward w on f.ward_id=w.ward_id where f.ward_id='" + session.getAttribute("wid") + "' and family_vstatus='2'";
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="NewFamilyRegistration.jsp?rid=<%=rs.getString("family_id")%>">Accept</a>
                </td>
            </tr>
            <%
                }
